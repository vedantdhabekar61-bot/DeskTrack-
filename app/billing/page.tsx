...
import { Check, CreditCard, ShieldCheck, Zap, Loader2, ArrowLeft, CheckCircle2 } from 'lucide-react';
        ...
        {showSuccessModal && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-6 backdrop-blur-sm">
            ...
            >
              ...
              <h2 className="mb-2 text-2xl font-bold text-slate-900">Payment Successful!</h2>
              <p className="mb-8 text-sm text-slate-500">
                You are now a Pro member. Enjoy unlimited features!
              </p>
              <button
                onClick={() => router.push('/')}
                className="w-full rounded-2xl bg-teal-500 py-4 font-bold uppercase tracking-widest text-white shadow-lg shadow-teal-500/20 active:scale-95 transition-all"
              >
                Go to Dashboard
              </button>
            </motion.div>
